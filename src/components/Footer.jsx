    ...
    <footer style={{ fontFamily: "'Helvetica Neue', Arial, sans-serif" }}>
      ...
      <div style={{
        ...
        <div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', margin: '20px 0 16px 0' }}>
            ...
            <span style={{ fontSize: '22px', fontWeight: '700', color: '#fff', letterSpacing: '-0.5px' }}>streamtube</span>
          </div>
          ...
          <div style={{ marginTop: '20px' }}>
            ...
            <div style={{ display: 'flex', gap: '12px', marginBottom: '20px' }}>
              ...
              <div>
                ...
                <span style={{ color: '#777', fontSize: '12px', display: 'flex', alignItems: 'center', gap: '4px' }}>
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="#777"><path d="M12 4.5C7 4.5 2.73 7.61 1 12c1.73 4.39 6 7.5 11 7.5s9.27-3.11 11-7.5c-1.73-4.39-6-7.5-11-7.5zM12 17c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5zm0-8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z"/></svg>
                  162 views
                </span>
              </div>
            </div>
      ...
      <div style={{
        ...
        <p style={{ color: '#777', fontSize: '13px', margin: 0 }}>
          ...
          <a href="#" style={{ color: '#aaa', textDecoration: 'underline' }}>WordPress</a>,{' '}
          Hosted by{' '}
          <a href="#" style={{ color: '#aaa', textDecoration: 'underline' }}>SiteGround</a>.
        </p>
      </div>
    </footer>
  );
